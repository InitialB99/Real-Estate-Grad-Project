        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav>
                <ul class="list-none flex space-x-8">
                    <li><a href="user_dashboard.php" class="hover:shadow-lg">Inapoi</a></li>
        ...
        <section class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="update_user.php" method="post" class="space-y-4">
                ...
                <div class="flex justify-center">
                    <button type="submit" name="update_user" class="bg-blue-500 text-white px-8 py-4 rounded-md mt-4 font-bold hover:bg-blue-700">Update</button>
                </div>
            </form>
        </section>
    </main>
